...
function wp_bootstrap_starter_scripts()
{
    ...
    // if($current_language === 'ar'){
        wp_enqueue_style('custom_style_rtl', get_template_directory_uri() . '/inc/assets/css/rtl.css', array(), '2.10');
        wp_enqueue_style('responsive_style_rtl', get_template_directory_uri() . '/inc/assets/css/responsive_rtl.css', array(), '2.10');
    ...
    if (function_exists('acf_register_block_type')) {
        ...
        acf_register_block_type(
            array(
                'name'              => 'Block12',
                'title'             => __('Block12'),
                'description'       => __('This is the twelveth Block of Homepage'),
                'render_template'   => 'blocks/Homepage_Blocks/block_12.php',
                'category'          => 'formatting',
                'icon'              => 'admin-comments',
                'keywords'          => array('testimonial', 'quote'),
            )
        ...
        acf_register_block_type(
            array(
                'name'              => 'Block15',
                'title'             => __('Block15'),
                'description'       => __('This is the fiftheenth Block of Homepage'),
                'render_template'   => 'blocks/Homepage_Blocks/block_15.php',
                'category'          => 'formatting',
                'icon'              => 'admin-comments',
                'keywords'          => array('testimonial', 'quote'),
            )
