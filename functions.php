...
function wp_bootstrap_starter_scripts()
{
    ...
    // if($current_language === 'ar'){
        wp_enqueue_style('custom_style_rtl', get_template_directory_uri() . '/inc/assets/css/rtl.css', array(), '1.83');
        wp_enqueue_style('responsive_style_rtl', get_template_directory_uri() . '/inc/assets/css/responsive_rtl.css', array(), '1.83');
